...
# 2️⃣ PandasKorrelyasiya & Kovariasiya
# df[['Area','Price']].cov()   # Kovariasiya
# df[['Area','Price']].corr()  # Correlation (-1 ... +1)


# Cov: birlikdə dəyişmə

# Corr: xətti əlaqənin gücü və istiqaməti
