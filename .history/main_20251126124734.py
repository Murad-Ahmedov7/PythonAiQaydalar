...
print(houses['Floor'].isnull().sum())
# houses['DistanceToMetro_km'].fillna(houses['DistanceToMetro_km'].median(), inplace=True) #inplace true referenceda deyisir inplace false(yeni defalut hali onda original usutunde deyisir)
# houses.to_excel("houses_day.xlsx",index=False)
# print(houses['DistanceToMetro_km'].median())
...
# 🔹 5️⃣ houses['price_vs_mean'] = ...
#
# Bu hesablanmış faiz fərqini yeni sütun kimi əlavə edir.
# Bu sütun hər sətir üçün belə görünür:
#
# +25%   → orta qiymətdən baha
# -15%   → orta qiymətdən ucuz
...
# houses DataFrame-i avtomatik analiz edir,
#
# nəticəni “Houses Day Report” adlı HTML faylına yazır,
#
# bu faylı açanda interaktiv, vizual analiz hesabatı görürsən
