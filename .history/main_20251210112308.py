...
# AI recommendation system (tövsiyə sistemi) — istifadəçinin əvvəlki davranışlarını, seçimlərini, axtarışlarını, kliklərini, bəyəndiklərini və ümumi istifadəçi məlumatlarını analiz edərək ona uyğun məzmun, məhsul və ya xidmət təklif edən süni intellekt sistemidir.
# Məsələn: Netflix → film tövsiyə edir, Spotify → musiqi, Amazon → məhsul, YouTube → video və s.

# Aşağıda sadə və tam başa düşülən şəkildə izah edirəm:



# 🔥 AI Recommendation Sistemləri Necə İşləyir?
# 1️⃣ Data Toplama (Input)

# Sistem ilk növbədə istifadəçi ilə bağlı müxtəlif məlumatları yığır:

# Baxdığın filmlər

# Dinlədiyin mahnılar

# Bəyəndiklərin / dislike etdiklərin

# Axtarış tarixçəsi

# Kliklər və izləmə müddəti

# Profil məlumatları (yaş, ölkə və s.)

# Digər istifadəçilərlə oxşar davranışlar

# Bu mərhələni data collection deyirlər.


# 2️⃣ Data Processing və Feature Extraction

# Toplanan məlumatlar sistem tərəfindən “feature” (xüsusiyyət) formasına salınır.

# Məsələn:
# “Bu istifadəçi action filmlərinə 70% üstünlük verir, romantik filmlərə 10%.”


# 3️⃣ Recommendation Algoritmi İşə Düşür

# Burada 3 əsas tip var:

# ⭐ 1. Collaborative Filtering (Ən məşhur)

# İstifadəçilərin oxşarlığına görə tövsiyə edir.

# İş prinsipi:

# Sən A, B, C filmlərinə baxmısan.

# Başqa bir istifadəçi də A, B, C filmlərinə baxıb, əlavə olaraq D filminə də baxıb.

# Sistem deyir:
# "Onda sənə də D filmi maraqlı ola bilər."

# Netflix, YouTube, Amazon bunu geniş istifadə edir.

# ⭐ 2. Content-Based Filtering

# Məhsulun öz xüsusiyyətlərini analiz edir.
...
# Musiqinin ritmi, tempi

# Məhsulun qiyməti, kateqoriyası və s.

# Sən action filmə baxırsansa — sistem digər action filmlərini tövsiyə edir.

# ⭐ 3. Hybrid System (Həm CB, həm CF)

# ⚡ Bu ən güclü sistemdir.
# Netflix, Spotify, TikTok — hamısı hybrid sistemi istifadə edir.

# Məsələn:

# Sənin seçimlərinə (content-based)

# Oxşar istifadəçilərin seçimlərinə (collaborative)

# Real-time davranışa (necə sürüşdürürsən, nə qədər baxırsan)
...
# Word2Vec — bu, Google tərəfindən hazırlanmış bir modeldir və məqsədi sözləri rəqəmsal vektorlara çevirməkdir.

# İnsan dilində sözlər bir-biri ilə əlaqəlidir, amma kompüterlər üçün “söz” sadəcə mətn simvoludur.

# Word2Vec sözlərin mənasını və kontekstini vektor formasında təmsil edir.

# Nəticədə hər söz bir n-dimensiyalı vektor olur (məsələn, 100 ölçülü).

# Xüsusiyyətlər:

# Sözlər oxşar kontekstdə istifadə olunursa, onların vektorları da yaxın olur.

# Məsələn: king – queen, man – woman vektorları oxşar nisbətlərdə yerləşir.

# Word2Vec əsasən iki üsulla öyrədilir:

# CBOW (Continuous Bag of Words) – kontekstdən mərkəz sözünü təxmin edir.

# Skip-gram – mərkəz sözündən konteksti təxmin edir.

# 2️⃣ Word Translations nədir?

# Word translation — sadəcə bir sözün bir dildən başqa dilə tərcüməsi deməkdir. Amma Word2Vec ilə əlaqəsi belə olur:

# Əgər sən Word2Vec vektorlarını fərqli dillər üçün öyrədərsən, sonra dillər arasında vektorların oxşarlığını istifadə edərək sözləri tərcümə edə bilərsən.

# Məsələn: İngilis dilində “apple” və Azərbaycan dilində “alma” sözlərinin vektorları bir-birinə yaxın olarsa, model bunu tərcümə kimi öyrənə bilər.
...
# Eyni üsul söz tərcüməsi üçün də işləyə bilər:

# vec("alma", az) ≈ vec("apple", en)


# Bu yanaşma machine translation-da və cross-lingual NLP-də istifadə olunur.
...
#8)Sekiller ucun Ann-den Cnn-e kecmek ucun meqsed o idi ki ann sekillerei 2d den 1 deye cevirib o seklin uzerinde gezirdi deye seklin keyfiyyeti itirdi kecmek sebebi o idi.ve hecmin ann de rengler de olculer de tam uygun deyildi.
