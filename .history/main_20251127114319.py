...
district=input("Enter the district: Yasamal,Nizami,Sebayil,Binaqadi,Nerimanov")
btype=input("Enter Building type (New,Old,Premium,Economy) ")
...
print(f"Texmin edilen ev qiymeti : {pred_price}")
#endregion 