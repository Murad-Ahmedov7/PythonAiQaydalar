...
#region PythonAi3
# Data Science (Məlumat Elmi) — müxtəlif mənbələrdən toplanan böyük həcmli məlumatları təhlil edib, onlardan nümunələr, tendensiyalar və faydalı nəticələr çıxarmağa yönəlmiş elmi və praktik sahədir. Məqsəd, məlumatlara əsaslanaraq qərar vermək, proqnozlaşdırmaq və problemləri həll etməkdir.

#topla,temizle,modellesdir,test et,islek hala getir
#endregion