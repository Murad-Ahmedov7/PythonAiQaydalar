...
“Regression xətaları” (və ya “Error metrics / Loss metrics”) – bu terminlər MAE, MSE, R² və digər oxşar ölçüləri əhatə edir, çünki bunlar proqnoz dəyərləri ilə real dəyərlər arasındakı fərqi ölçür.